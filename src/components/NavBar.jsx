...
const NavBar = ({ header }) => {
  ...
  return (
    <header className='bg-white bg-bgimage bg-no-repeat bg-cover  min-h-[500px] bg-center flex flex-col'>
      <nav className='flex justify-center'>
        <div className='text-white grid grid-cols-3 w-[90%] py-auto mt-9 ' >
          ...
          <div className='flex justify-end items-center'><NavLink to={'/subscribe'} className='bg-color py-1 px-9 rounded-3xl hover:bg-transparent hover:text-[#7379ff]'>SUBSCRIBE</NavLink></div>
        </div>
      </nav>
